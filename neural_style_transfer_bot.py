...
Original file is located at
    https://colab.research.google.com/drive/1TdGFu9k8-9ou1nz1QInBKglC7F9YW31M
"""
...
def get_photo(message):
    ...
    if first and not second:
        ...
        with open(file_name, "rb") as file:
            data = file.read()
        bot.send_photo(message.from_user.id, photo=data).wait()
        first = False
        second = False
        name1 = ''
        name2 = ''
        file_name = ''
        bot.send_message(message.from_user.id, "Пожалуйста, отправьте первую фотографию - фотографию, с которой нужно перенести стиль.").wait()
